...
var StandService = /*#__PURE__*/function (_RequestService) {
  function StandService(context) {
    (0, _classCallCheck2["default"])(this, StandService);
    if (!context) {
      throw new Error("Cannot do the request without context");
    }
    return _callSuper(this, StandService, [{
      baseUrl: context.config.portal.baseUrl
    }]);
  }
  (0, _inherits2["default"])(StandService, _RequestService);
  return (0, _createClass2["default"])(StandService, [{
    ...
    key: "getSuppliers",
    value: function getSuppliers(sourceType, sourceId, pageTypeId, companyId) {
      this.setParams({
      ...
      return this.get("/ajax/request/buttons-and-suppliers.json");
    }
  }, {
...
var _default = exports["default"] = StandService;