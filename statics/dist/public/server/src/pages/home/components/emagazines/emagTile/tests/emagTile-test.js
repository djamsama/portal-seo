...
test("emagTile", function () {
  // eslint-disable-next-line no-undef
  var emagTile = mountWithIntl(/*#__PURE__*/_react["default"].createElement(_reactRedux.Provider, {
    store: store
  }, /*#__PURE__*/_react["default"].createElement(_index["default"], {
    item: item,
    link: link
  })));
  expect(emagTile.find(_tile["default"]).exists()).toEqual(true);
});