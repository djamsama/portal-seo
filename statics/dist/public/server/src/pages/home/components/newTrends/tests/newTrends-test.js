...
var trendUri = "/ajax/home/";
var url = new RegExp("".concat(trendUri, "/*"));
_mockAdapter.mock.onGet(url).reply(200, mockTrend);
var context = {
  config: {
    portal: portal
  },
...
test("NewTrends async", /*#__PURE__*/(0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator().m(function _callee() {
  var nexTrendsWrapper;
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      case 0:
        // eslint-disable-next-line no-undef
        nexTrendsWrapper = mountWithIntl(/*#__PURE__*/_react["default"].createElement(_context2.AppContext.Provider, {
          value: context
      ...
      case 1:
        nexTrendsWrapper.update();
        expect(nexTrendsWrapper.find({
          href: "http://trends.archiexpo.fr/jspr/project-52222-257775.html"
        }).exists()).toEqual(true);
      case 2:
        return _context.a(2);
    }
