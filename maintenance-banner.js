    ...
    banner.innerHTML = '' +
      '<div class="maintenance-banner-panel">' +
        '<div class="maintenance-banner-grid">' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-gb.svg" alt="GB" /><div><h3 class="maintenance-banner-title">Maintenance in progress</h3><p class="maintenance-banner-text">Our websites are currently experiencing a technical issue. Our teams are actively working to restore service as soon as possible.</p><p class="maintenance-banner-text">Thank you for your understanding.</p></div></article>' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-fr.svg" alt="FR" /><div><h3 class="maintenance-banner-title">Maintenance en cours</h3><p class="maintenance-banner-text">Nos sites rencontrent actuellement un problème technique. Nos équipes travaillent activement à leur rétablissement dans les plus brefs délais.</p><p class="maintenance-banner-text">Merci de votre compréhension.</p></div></article>' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-de.svg" alt="DE" /><div><h3 class="maintenance-banner-title">Wartungsarbeiten im Gange</h3><p class="maintenance-banner-text">Unsere Websites haben derzeit ein technisches Problem. Unsere Teams arbeiten aktiv an einer schnellstmöglichen Wiederherstellung.</p><p class="maintenance-banner-text">Vielen Dank für Ihr Verständnis.</p></div></article>' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-it.svg" alt="IT" /><div><h3 class="maintenance-banner-title">Manutenzione in corso</h3><p class="maintenance-banner-text">I nostri siti web stanno attualmente riscontrando un problema tecnico. I nostri team stanno lavorando attivamente per ripristinare il servizio il prima possibile.</p><p class="maintenance-banner-text">Grazie per la comprensione.</p></div></article>' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-es.svg" alt="ES" /><div><h3 class="maintenance-banner-title">Mantenimiento en curso</h3><p class="maintenance-banner-text">Nuestros sitios web están experimentando actualmente un problema técnico. Nuestros equipos están trabajando activamente para restablecer el servicio lo antes posible.</p><p class="maintenance-banner-text">Gracias por su comprensión.</p></div></article>' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-cn.svg" alt="CN" /><div><h3 class="maintenance-banner-title">网站维护中</h3><p class="maintenance-banner-text">我们的网站目前遇到技术问题。我们的团队正在积极努力尽快恢复服务。</p><p class="maintenance-banner-text">感谢您的理解</p></div></article>' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-jp.svg" alt="JP" /><div><h3 class="maintenance-banner-title">現在メンテナンス中です</h3><p class="maintenance-banner-text">現在、当社のウェブサイトで技術的な問題が発生しております。復旧に向けてチームが対応しております。</p><p class="maintenance-banner-text">ご理解のほどよろしくお願いいたします。</p></div></article>' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-pt.svg" alt="PT" /><div><h3 class="maintenance-banner-title">Manutenção em andamento</h3><p class="maintenance-banner-text">Nossos sites estão enfrentando um problema técnico no momento. Nossas equipes estão trabalhando ativamente para restabelecer o serviço o mais rápido possível.</p><p class="maintenance-banner-text">Agradecemos a sua compreensão.</p></div></article>' +
          '<article class="maintenance-banner-item"><img class="maintenance-banner-flag" src="/icons/flags/flag-ru.svg" alt="RU" /><div><h3 class="maintenance-banner-title">Техническое обслуживание</h3><p class="maintenance-banner-text">В настоящее время на наших сайтах возникла техническая проблема. Наши специалисты активно работают над скорейшим восстановлением работы.</p><p class="maintenance-banner-text">Благодарим за понимание.</p></div></article>' +
        '</div>' +
      '</div>';
