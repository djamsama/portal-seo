...
test("BuyingGuideTile", function () {
  // eslint-disable-next-line no-undef
  var buyingGuideTile = mountWithIntl(/*#__PURE__*/_react["default"].createElement(_index["default"], {
    item: item,
    link: link
  }));
  expect(buyingGuideTile.find(_buyingGuideTile.WrapperDivTile).exists()).toEqual(true);
});