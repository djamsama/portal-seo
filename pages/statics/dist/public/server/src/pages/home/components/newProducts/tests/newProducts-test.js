...
_mockAdapter.mock.onGet(url).reply(200, mockProduct);
var context = {
  config: {
    portal: portal
  },
...
test("NewProducts async", /*#__PURE__*/(0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator().m(function _callee() {
  var newProductsWrapper;
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      case 0:
        newProductsWrapper = mountWithIntl(/*#__PURE__*/_react["default"].createElement(_context2.AppContext.Provider, {
          value: context
      ...
      case 1:
        newProductsWrapper.update();
        expect(newProductsWrapper.find({
          href: "http://www.archiexpo.fr/prod/nowatt-lighting/product-148613-2012110.html"
        }).exists()).toEqual(true);
      case 2:
        return _context.a(2);
    }
