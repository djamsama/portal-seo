...
var _stand = require("./styles/stand");
var _relatedLinks = _interopRequireDefault(require("../../components/relatedLinks"));
var _standHeader = _interopRequireDefault(require("./components/standHeader"));
...
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); } /* eslint-disable array-callback-return */ /* eslint-disable no-param-reassign */
var ELEMENT_TYPE_PRODUCT = "product";
var Stand = /*#__PURE__*/function (_ContextComponent) {
  function Stand(props, context) {
    ...
    _this.addToHistory = _this.addToHistory.bind(_this);
  ...
  return (0, _createClass2["default"])(Stand, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.pageTypeId) {
        if (!viewedPageId) {
          ...
          // $FlowFixMe
          var trackingInfoList = TrackingHelper.registerVisitContentList(elementList, ELEMENT_TYPE_PRODUCT);
    ...
    value: function addToHistory() {
      ...
      var productStandDTO = initData ? initData.productStandDTO : {};
      if (productStandDTO && productStandDTO.productId) {
        var locale = config && config.portal && config.portal.locale ? config.portal.locale : _constants.DEFAULT_LOCALE;
        var newId = productStandDTO.productId;
        var recordedReco = (0, _histoRecoStorageService.getFromStorage)(_constants.LOCAL_STORAGE_RECO_KEY, locale, newId) || [];
        recordedReco.push(newId);
        (0, _histoRecoStorageService.saveInStorage)(_constants.LOCAL_STORAGE_RECO_KEY, locale, recordedReco, _constants.HISTORY_PRODUCTS_MAX);
      }
    }
    ...
    value: function doTrack() {
      ...
      // $FlowFixMe
      var trackingInfoList = TrackingHelper.registerVisitContentList(trackingInfo.elementList, ELEMENT_TYPE_PRODUCT);
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_stand.StandWrapper, null, linkedData && /*#__PURE__*/_react["default"].createElement(_linkedData["default"], {
