...
var _index = _interopRequireDefault(require("../conversation/index"));
...
test("  conversation", /*#__PURE__*/(0, _asyncToGenerator2["default"])(/*#__PURE__*/_regenerator().m(function _callee() {
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      case 0:
        (0, _testUtils.act)(function () {
          // eslint-disable-next-line no-undef
          var conversation = shallowWithIntl(/*#__PURE__*/_react["default"].createElement(_context2.AppContext.Provider, {
            value: context
          }, /*#__PURE__*/_react["default"].createElement(_reactRedux.Provider, {
            store: store
          }, /*#__PURE__*/_react["default"].createElement(_index["default"], {
            visitorLanguage: mockRfq.visitorLanguage,
            conversation: mockRfq.supplierHistory[0]
          }))));
          expect(conversation.find({
            visitorLanguage: "fr"
          }).exists()).toEqual(true);
        });
      case 1:
